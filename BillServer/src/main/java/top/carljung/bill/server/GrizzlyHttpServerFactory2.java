 ...
 * @see HttpServer
 * @see GrizzlyHttpContainer2
 */
public final class GrizzlyHttpServerFactory2 {
    ...
    public static HttpServer createHttpServer(final URI uri) {
        return createHttpServer(uri, (GrizzlyHttpContainer2) null, false, null, true);
    }
    ...
    public static HttpServer createHttpServer(final URI uri, final boolean start) {
        return createHttpServer(uri, (GrizzlyHttpContainer2) null, false, null, start);
    }
    ...
    public static HttpServer createHttpServer(final URI uri, final ResourceConfig configuration) {
        return createHttpServer(
                uri,
                new GrizzlyHttpContainer2(configuration),
                false,
                null,
                true
        );
    ...
    public static HttpServer createHttpServer(final URI uri,
        ...
        return createHttpServer(uri, new GrizzlyHttpContainer2(config, parentContext), secure, sslEngineConfigurator,
                true);
    }
    ...
    public static HttpServer createHttpServer(final URI uri,
                                              final ResourceConfig config,
                                              final Object parentContext) {
        return createHttpServer(uri, new GrizzlyHttpContainer2(config, parentContext), false, null, true);
    }
     ...
     */
    public static HttpServer createHttpServer(final URI uri,
                                              final GrizzlyHttpContainer2 handler,
                                              final boolean secure,
                                              final SSLEngineConfigurator sslEngineConfigurator,
                                              final boolean start) {
     ...
     */
    private GrizzlyHttpServerFactory2() {
    }
}
